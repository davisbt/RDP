 ...
 */
public class BluetoothEV3Service {
    // Debugging
    private static final String TAG = "BluetoothEV3Service";
    private static final boolean D = true;

    // Unique UUID for this application
    private static final UUID MY_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    //private static final UUID MY_UUID = UUID.fromString("0000110c-0000-1000-8000-00805f9b34fb");
    // Member fields
     ...
     */
    public BluetoothEV3Service(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
		...
		public void run() {
            ...
            try {
                ...
                BluetoothEV3Service.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (BluetoothEV3Service.this) {
                mConnectThread = null;
            }
